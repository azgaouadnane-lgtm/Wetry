...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newApp = [
        ...
        'icon_app'       => sanitizeUrl($_POST['icon_app'] ?? ''),
        'bg'             => sanitizeUrl($_POST['bg'] ?? ''),
        'popup_type'     => sanitize($_POST['popup_type'] ?? 'mod'),
        'resource_icon'  => sanitizeUrl($_POST['resource_icon'] ?? ''),
        'reward_amounts' => [
        ...
        'download'       => sanitize($_POST['download'] ?? ''),
        ...
        'is_slider'      => isset($_POST['is_slider']),
        'is_discover'    => isset($_POST['is_discover']),
        'type'           => sanitize($_POST['type'] ?? ''),
        's1'             => sanitize($_POST['s1'] ?? ''),
        'geo'            => $geoRules
    ];
...
<head>
    <meta charset="UTF-8">
    <title>Add App | SpiderMod Admin</title>
...
<body>
    <nav class="admin-nav">
        ...
        <div class="nav-links">
            <a href="dashboard.php" class="nav-link text-slate-400">
            ...
            <form method="post" action="add.php">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="icon_app" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Background Image URL</label>
                        <input type="url" name="bg" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="popup_type" class="form-control select2-basic" required>
                                <option value="mod">Mod Popup (Download Style)</option>
                                <option value="reward">Reward Popup (Generator Style)</option>
                                <option value="gift">Gift Card/Coupon (Voucher Style)</option>
                            </select>
                        </div>
                        <div class="form-group" id="resource-icon-group">
                            <label>Resource Icon URL</label>
                            <input type="url" name="resource_icon" class="form-control" placeholder="https://i.imgur.com/diamond.png">
                        </div>
                    </div>

                    <div class="form-group" id="coupon-code-group" style="display:none;">
                        <label>Voucher Code (e.g. SP-XXXX-XXXX-1234)</label>
                        <input type="text" name="coupon_code" class="form-control" placeholder="Enter the full code here">
                    ...
                    <div class="form-group" id="amounts-group">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
                            <input type="number" name="amount_1" class="form-control" placeholder="Amt 1" value="1000">
                            <input type="number" name="amount_2" class="form-control" placeholder="Amt 2" value="5000">
                            <input type="number" name="amount_3" class="form-control" placeholder="Amt 3" value="8000">
                            <input type="number" name="amount_4" class="form-control" placeholder="Amt 4" value="9999">
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="download" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Badge Label (e.g. FREE)</label>
                            <input type="text" name="badge" class="form-control" placeholder="Default: FREE">
                        </div>
                        <div class="form-group">
                            <label>S1 Tracking ID (Optional)</label>
                            <input type="text" name="s1" class="form-control" placeholder="e.g. app_freefire_en">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <label class="trending-switch">
                                <input type="checkbox" name="is_discover" value="1">
